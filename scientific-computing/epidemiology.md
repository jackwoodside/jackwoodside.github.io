...
In these notebooks we will go through several variations of the SIR model for modelling disease spread. We will start with a basic model, and then add variations to make some of the assumptions more realistic for certain cases.
